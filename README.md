...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-hill-6a34
```

A live public deployment of this template is available at [https://raspy-hill-6a34.templates.workers.dev](https://raspy-hill-6a34.templates.workers.dev)
